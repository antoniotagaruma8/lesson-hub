          ...
          <div className="relative group tour-step-profile">
            <button className="text-left flex items-center gap-2 hover:opacity-80 transition-opacity">
              <div>
                ...
                <p className="text-[10px] text-slate-500 tracking-wider font-bold">{currentProfile?.subtitle || 'Please import or add one'}</p>
              </div>
                  ...
                  <div className="p-8 text-center bg-white border border-dashed border-slate-200 rounded-xl text-slate-400">
                    {isAdmin && currentProfile ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-sm font-medium">No schedule profile found.</p>
                        {isOwner && (
                          <button
                            onClick={() => setIsAddScheduleModalOpen(true)}
                            className="mt-2 text-xs font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-full hover:bg-blue-100 transition-colors"
                          >
